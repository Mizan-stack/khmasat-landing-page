    ...
    <div className="space-y-5" dir="rtl">
      ...
      <div className="flex flex-wrap justify-between gap-3">
        ...
        <MotionButton
          ...
          whileTap={{ scale: 0.97 }}
          onClick={onContinue}
          className="inline-flex h-12 min-w-36 items-center justify-center rounded-2xl bg-[var(--ads-create-bg)] px-7 text-base font-black text-[var(--ads-button-ghost-text)] dark:text-[var(--ads-create-text)]"
        >
          التالي
        </MotionButton>
      </div>
