    ...
    <div className="space-y-5" dir="rtl">
      ...
      <div className="flex justify-end">
        <MotionButton
          ...
          className="inline-flex h-12 min-w-36 items-center justify-center rounded-2xl bg-[var(--ads-create-bg)] px-7 text-base font-black text-[var(--ads-button-ghost-text)] dark:text-[var(--ads-create-text)] disabled:cursor-not-allowed disabled:opacity-55"
        >
          التالي
        </MotionButton>
      </div>
