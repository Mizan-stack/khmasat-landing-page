...
function HomeStoryTabsSection() {
  ...
  return (
    <section id="about" className="mx-auto w-full max-w-[1320px] px-3 pb-20 md:px-6">
      <div className="relative overflow-hidden rounded-[34px] border border-[var(--home-story-border)] [background:var(--home-story-bg)] p-5 md:p-8">
        <MotionSpan
          aria-hidden
